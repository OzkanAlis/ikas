...
(function () {
  ...
  function addBedenTablosu(targetDiv) {
    ...
    // (B) Kişi Sayısı (ilk yüklemede rastgele)
    let randomPersonCount = getRandomInt(1, 4);
    ...
    container.innerHTML = `
      <style>
        ...
        /* (1) Kişi Sayısı & Stok Bilgisi Yazıları Daha Küçük */
        .info-line {
          display: flex;
          align-items: center;
          margin-bottom: 10px;
        ...
        /* (3) TAKSİT BÖLÜMÜ - Yazı boyutu biraz küçüldü */
        .taksit-secenekleri {
        ...
        /* (6) İndirim Kuponu Alanı - Yazı boyutu biraz küçüldü */
        .discount-section {
          border: 1px solid #ccc;
          border-radius: 8px;
          background-color: #fff;
    ...
    // (8) Kişi sayısı her 10 saniyede bir rastgele güncellensin
    const randomCountEl = container.querySelector('.random-count');
    setInterval(() => {
      const newCount = getRandomInt(1, 4);
      randomCountEl.textContent = newCount + " Kişi";
    }, 10000);
